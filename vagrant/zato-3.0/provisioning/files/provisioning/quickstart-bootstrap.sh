...
/opt/zato/current/bin/zato quickstart create --odb_host localhost --odb_user postgres --odb_db_name zato --kvdb_password '' /opt/zato/env/qs-1/ postgresql localhost 6379
/opt/zato/current/bin/zato from-config /opt/zato/update_password.config || exit 1
