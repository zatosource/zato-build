...
# /opt/zato/current/bin/zato delete odb --verbose --odb_host localhost --odb_user zato --odb_password mysupersecretpassword --odb_db_name zato postgresql
/opt/zato/current/bin/zato quickstart create --verbose --odb_host localhost --odb_user zato --odb_password mysupersecretpassword --odb_db_name zato --kvdb_password '' /opt/zato/env/qs-1/ postgresql localhost 6379
