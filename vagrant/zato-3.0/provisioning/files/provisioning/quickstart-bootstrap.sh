...
/opt/zato/current/bin/zato quickstart create --verbose --odb_host localhost --odb_user 5432 --odb_user zato --odb_password mysupersecretpassword --odb_db_name zato --kvdb_password '' /opt/zato/env/qs-1/ postgresql localhost 6379
